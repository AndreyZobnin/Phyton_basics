"""Пример 3 - Возьмите любые 1-3 задания из прошлых домашних заданий.
...
from Task3_classes import Bird, Fish, Mammal
...
def pars():
    parser = argparse.ArgumentParser(prog='Задача №3 ДЗ 15',
